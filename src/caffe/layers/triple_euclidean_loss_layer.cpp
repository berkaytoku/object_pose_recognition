...
void TripleEuclideanLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void TripleEuclideanLossLayer<Dtype>::Forward_cpu(
...
template <typename Dtype>
void TripleEuclideanLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(TripleEuclideanLossLayer);
#endif

INSTANTIATE_CLASS(TripleEuclideanLossLayer);
REGISTER_LAYER_CLASS(TripleEuclideanLoss);
